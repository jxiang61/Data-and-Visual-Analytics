...
"""
def author():
        return 'jxiang37' # replace gburdell3 with your Georgia Tech username.

def gtid():
    return 903519239 # replace with your GT ID number
...
#############################################
            ...
            for i in range(length):
                scores[i] = new_scores[i] + (1-damping_factor) * node_weights[i]
#############################################
